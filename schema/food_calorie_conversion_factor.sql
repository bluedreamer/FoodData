...
--
-- Table structure for table `food_calorie_conversion_factor`
--
...
CREATE TABLE `food_calorie_conversion_factor` (
  `food_nutrient_conversion_factor_id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'ID of the related row in the nutrient_conversion_factor table',
  `protein_value` decimal(10,4) DEFAULT NULL COMMENT 'The multiplication factor for protein',
