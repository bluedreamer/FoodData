...
CREATE TABLE `food` (
  `fdc_id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Unique permanent identifier of the food',
  `data_type` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT 'Type of food data',
